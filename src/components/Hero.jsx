        ...
        <div className="text-white"> 
            <div className='max-w-[800px] mt-[-96px] w-full h-screen mx-auto text-center flex flex-col justify-center'>
                ...
                <div className="flex justify-center items-center">
                    ...
                    <Typed 
                    className="md:text-4xl sm:text-4xl text-xl md:pl-4 pl-2 font-bold"
                ...
                <button className="bg-[#00df9a] w-[200px] rounded-md my-6 mx-auto py-3 font-medium text-black">Get Started</button>
            </div>
        </div>
    )
}
